...
export default async function Page() {
  return (
    <section className="container mx-auto grid grid-cols-1 gap-6 p-12">
        <svg className="absolute left-0 md:left-40 top-20 w-[60%] h-[60%] -z-10 blur-3xl opacity-30 overflow-hidden animate-svg1" 
        ...
        <svg className="absolute top-5 left-0 xl:left-68 w-[80%] h-[80%] -z-10 blur-3xl opacity-30 overflow-hidden animate-svg2" 
        ...
        <svg className="max-w-screen absolute top-[40vh] right-40 w-[50%] h-[40%] -z-10 blur-3xl opacity-30 overflow-hidden animate-svg3" 
