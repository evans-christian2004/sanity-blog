...
export default async function Page() {
  return (
    <section className="container mx-auto grid grid-cols-1 gap-6 p-12">
        ...
        <div className="glass-body h-screen w-screen absolute inset-0 -z-2"></div>
        <svg className="absolute left-0 md:left-40 top-20 w-[60%] h-[60%] -z-10 blur-2xl opacity-30 animate-svg1" 
        ...
        <svg className="absolute top-5 left-0 xl:left-68 w-[80%] h-[80%] -z-10 blur-2xl opacity-30 animate-svg2" 
        ...
        <svg className="max-w-screen absolute top-[40vh] right-40 w-[50%] h-[40%] -z-10 blur-2xl opacity-30 animate-svg3" 
        ...
        <div className="flex flex-col mt-[15vh] md:mt-[18vh] mx-auto max-w-2/3 ">
          ...
          <div className="hidden md:block h-30">
            <div className="bg-black p-5 rounded-lg shadow-lg border-12 border-gray-200 w-96 text-left m-auto">              
              ...
              ><Link className="flex items-center gap-2" href="/posts">Check it Out <div className="text-xl group-hover:ml-2 transition-all ease-in">&rarr;</div></Link></button>
            </div>
          </div>
